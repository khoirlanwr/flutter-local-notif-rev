...
class HalamanPrint extends StatefulWidget {
  ...
  HalamanPrint({this.idUser, this.namaMhs, this.idBuku, this.judulBuku}); 
...
class _HalamanPrintState extends State<HalamanPrint> {
  ...
  Future<Ticket> testTicket(PaperSize paper) async {
    ...
    ticket.text('-----------------------------------------');      
    // ticket.text('ID peminjaman: ' + widget.idPeminjaman);      
    ...
    ticket.text('Kode inventaris: ' + widget.idBuku);
