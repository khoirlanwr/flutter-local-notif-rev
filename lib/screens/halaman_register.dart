...
class _HalamanRegisterState extends State<HalamanRegister>
  ...
  Widget inputNRP() {
    return new Padding(
      padding: EdgeInsets.fromLTRB(0, sizeConfig.getBlockVertical(3), 0, 0),
  ...
  Widget inputTglLahir() {
    return new Padding(
      padding: EdgeInsets.all(sizeConfig.getBlockHorizontal(1)),
      child: Row(
  ...
  Widget showPrimaryButton() {
    return new Padding(
      padding: EdgeInsets.fromLTRB(0, sizeConfig.getBlockVertical(2), 0, 0),
      child: SizedBox(
