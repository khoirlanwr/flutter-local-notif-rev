...
class HalamanTambahEditKategori extends StatefulWidget {

  static const String id = "HALAMANTAMBAHEDITKATEGORI";

  final BaseUser user;
  final RecordKategori record;

  HalamanTambahEditKategori({this.record, this.user});

  @override
  _HalamanTambahEditKategoriState createState() => _HalamanTambahEditKategoriState();

  
}

class _HalamanTambahEditKategoriState extends State<HalamanTambahEditKategori> {
  ...
  Widget summaryCash() {
    ...
    String tahun = widget.record.tahunTerbit;
    String kategori = widget.record.kategori;
    var stokBuku = widget.record.stok;
                ...
                children: <Widget>[
                  ...
                  Expanded(
                    child:  Column(
                      ...
                      children: <Widget>[                  
                        Text('$tahun', style: TextStyle(color: Colors.black, fontSize: sizeConfig.getBlockHorizontal(3), fontWeight: FontWeight.bold)),
                        Divider(color: Colors.white, height: sizeConfig.getBlockVertical(1)),
  ...
  Widget itemBuku() {
    ...
    UmumRes umumresv1 = widget.record.umumRes;
    String umumres = "Umum";
